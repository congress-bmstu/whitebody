...
#figure(
	image("images/image-4.png", width: 80%)
)
...
#figure(
	image("images/image-3.png", width: 71%),
)
...
#figure(
	image("images/image-7.png", width: 75%)
)
...
#figure(
	image("images/image-8.png", width: 85%)
)

= Докажите условия устойчивости $p$-кратного цикла одномерного дискретного отображения.

#figure(
	image("images/image-9.png", width: 65%)
)

#figure(
	image("images/image-10.jpg", width: 70%)
)

#figure(
	image("images/image-11.jpg", width: 83%)
)

#figure(
	image("images/image-12.png", width: 65%)
)
